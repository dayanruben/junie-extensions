...
**This check is mandatory. Do not proceed until both steps pass.**
...
`boost:install` generates project-specific AI guidelines, installs Laravel best practices skills, and configures MCP tools (routes, schema, logs, Tinker). Without it the AI has no project context.
